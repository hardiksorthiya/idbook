(function ($) {
  ...
  panoContainer = document.querySelector(".sorath-panoroma-img");
  ...
  var panoHint = document.querySelector(".about-img .pano-move-hint");
  if (panoHint) {
    panoHint.parentElement.addEventListener("pointerdown", function () {
      panoHint.classList.add("is-hidden");
    }, true);
  }
  ...
  $(document).ready(function () {
    ...
    $(".sorath-image-comparison").twentytwenty({
    ...
    function menuSticky() {
      ...
      $(window).off("scroll.sticky").on("scroll.sticky", updateSticky);
      updateSticky();
    }
    ...
    mm.add("(min-width: 1024px)", () => {
      ...
      gsap.fromTo(scrollImg, { scale: 0.75 }, {
        scale: 1.25,
        ease: "none",
        scrollTrigger: {
          trigger: scrollArea,
      ...
      return () => gsap.set(scrollImg, { scale: 1 });
    });
  ...
  sm.add("(min-width: 768px)", () => {
    if (
      document.querySelector("#sorath-smooth-wrapper") &&
      document.querySelector("#sorath-smooth-content")
    ) {
